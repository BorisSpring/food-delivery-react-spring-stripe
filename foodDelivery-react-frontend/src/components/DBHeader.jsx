...
const DBHeader = () => {
  ...
  return (
    <div className='flex items-center justify-between px-4 md:px-10 w-full'>
      <div>
        <p className='text-headingColor font-[500]'>Welcome to the city</p>
        <p className='text-textColor text-sm'>Hello Boris Dimitrijevic</p>
      </div>
        ...
        <div className='flex gap-2 items-center justify-center'>
          <div className='w-9 h-9 rounded-md overflow-hidden bg-white shadow-md flex gap-2 items-center justify-center'>
            <motion.img
              ...
              src={user?.image ? user.image : '/src/assets/img/avatar.png'}
            />
          </div>
          <motion.div
            {...buttonClick}
